...
# Bot information
SESSION = environ.get('SESSION', 'KOLKATA')
...
PICS = (environ.get('PICS', 'https://envs.sh/4R0.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/khT.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/khT.jpg")
...
req_channel = int(os.environ.get('REQ_CHANNAL',''))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "kolkatabengali")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kolkatacollection')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Thankyou For Join Kolkata Bot 💘✨')
...
YEARS = [str(y) for y in range(1900, 1901)] + [str(y) for y in range(1991, 2026)]
...
#Necha Wala Mai changes maat karna 
